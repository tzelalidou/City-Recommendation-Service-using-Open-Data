...
public class ElderTraveller extends Traveller{
    public ElderTraveller(int[] grade, double[] local_geodesic, int age,String name) {
    ...
    public ElderTraveller(String name, int age,int[] grade)  {
        super(name,age,grade);
    }
    public ElderTraveller(String name,int[] grade)  {
        super(name,grade);
    }
    @Override
    ...
    public String toString() {
        return "Elder Traveller "+super.toString();
    }
}
